    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                PhoneNumber = await UserManager.GetPhoneNumberAsync(User.Identity.GetUserId<int>()), // userId),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(User.Identity.GetUserId<int>()), //userId),
                Logins = await UserManager.GetLoginsAsync(User.Identity.GetUserId<int>()), //userId),
                BrowserRemembered = await AuthenticationManager.TwoFactorBrowserRememberedAsync(User.Identity.GetUserId())//userId)
            };
            return View(model);
        }
