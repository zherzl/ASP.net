...
namespace MVC_PayPal.Controllers.Payment
{
    public class PaypalController : Controller
    {
        ...
        public ActionResult PaymentWithCreditCard()
        {
            ...
            crdtCard.first_name = "Miro";
            crdtCard.last_name = "Miric";
            crdtCard.number = "4032039392270833"; //enter your credit card number here
            ...
            tran.invoice_number = r.Next(100000).ToString();
        ...
        private PayPal.Api.Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            transactionList.Add(new Transaction()
            {
                ...
                invoice_number = r.Next(100000).ToString(),
                amount = amount,
                item_list = itemList
            });
